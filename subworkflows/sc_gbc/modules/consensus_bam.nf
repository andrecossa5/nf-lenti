...
process CONSENSUS_BAM {
  ...
  samtools fastq ${cell_folder}/consensus_unmapped.bam \
    ...
    | fgbio --compression 1 --async-io ZipperBams --unmapped ${cell_folder}/consensus_unmapped.bam --ref ${params.ref} --tags-to-reverse Consensus --tags-to-revcomp Consensus --output ${cell_folder}/consensus_mapped.bam 
