...
def filter_and_pivot(df_combos, umi_treshold=5, p_treshold=.01, max_ratio_treshold=.8, normalized_abundance_treshold=.8):
    ...
    print('-----------------------------------')
    print('df_combos[umi]_mean=',df_combos['umi'].median(), 'th=',umi_treshold)
    print('df_combos[max_ratio]_mean=',df_combos['max_ratio'].median(), 'th=',max_ratio_treshold)
    print('df_combos[normalized_abundance]_mean=',df_combos['normalized_abundance'].median(), 'th=',normalized_abundance_treshold)
    print('df_combos[p]_mean=',df_combos['p'].median(), 'th=',p_treshold)
    print('-----------------------------------')
...
def cell_assignment_workflow(
    ...
    print('######################################################')
    if path_sample_map==None:
        print('path_sample_map is None')
    if path_bulk==None:
        print('path_bulk is None')
